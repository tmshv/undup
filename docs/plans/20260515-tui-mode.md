...
- [ ] Step 1: Add the stub `Run` function
...
- [ ] Step 2: Add the `--tui` / `-i` flag and `runTUI` dispatcher
...
- [ ] Step 3: Verify build and existing modes still work
...
- [ ] Step 4: Manual smoke check on the stub
