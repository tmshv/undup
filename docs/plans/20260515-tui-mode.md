...
- [x] Step 3: Implement move prompt
...
- [x] Step 3: Define action message and command
...
- [x] Step 4: Run all tests and verify they pass
...
- [x] Step 3: Implement walk + message + expansion hook
...
- [x] Step 3: Manual smoke test on a temp tree (skipped - not automatable)
...
- [x] Step 4: Manual smoke test for delete flow (skipped - not automatable)
...
- [x] Step 5: Manual smoke test for move flow (skipped - not automatable)
...
- [x] Step 6: Verify move-target-inside-root is refused (skipped - not automatable)
...
- [x] Step 2: Add the new package and flag to CLAUDE.md
...
- [x] Step 3: Verify build and tests still pass
...
- [x] `go vet ./...` is clean.
- [x] `go test ./...` is green.
- [x] `./undup --tui /tmp/undup-tui-smoke` opens the TUI; `q` exits with status 0. (skipped - not automatable)
- [x] `./undup -m archives <root>` (no `--tui`) prints exactly the same output it did on `master` before this branch. (skipped - not automatable)
- [x] A delete with a directory member shows "Includes 1 directory (recursive)" in the confirm modal. (skipped - not automatable)
- [x] A move with target inside the scan root is rejected with a toast and leaves the filesystem unchanged. (skipped - not automatable)
